...
- Remove the inactivity-only tests and mock behavior; retain coverage for cancellation-based cleanup and other runtime liveness behavior.
...
- [ ] Remove prompt inactivity timeout state, configuration, timer, and listener bookkeeping.
- [ ] Update tests and mock fixtures for the changed prompt behavior.
- [ ] Update current product and architecture documentation.
- [ ] Review compatibility surfaces and record that no compatibility shim is needed.
- [ ] Run focused and full server validation.
